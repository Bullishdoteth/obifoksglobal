          ...
          <div className="lg:col-span-5 p-6 sm:p-8 flex flex-col justify-between space-y-8">
            ...
            <div className="pt-4 border-t border-zinc-200">
              <a
                ...
                className="w-full inline-flex items-center justify-center gap-2.5 bg-[#25D366] hover:bg-[#20bd5a] text-white font-bold text-xs sm:text-sm py-4 px-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-200 active:scale-[0.99] group cursor-pointer"
              >
